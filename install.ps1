...
Write-Host "${CYAN}${BOLD}  ╰──────────────────────────────────────╯${RST}"
Write-Host "${DIM}  version v1.0.6 · github.com/HaYanJongSeong/kras-quick${RST}"
Write-Host ''

$u = 'https://github.com/HaYanJongSeong/kras-quick/releases/download/v1.0.6/kras_quick_v1.0.6.exe'
